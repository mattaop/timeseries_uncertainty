...
from tensorflow.python.keras.layers import Input, Dense, Wrapper
...
class ConcreteDropout(Layer):
    ...
    def __init__(self, weight_regularizer=1e-6, dropout_regularizer=1e-5,
                 init_min=0.1, init_max=0.1, is_mc_dropout=False, **kwargs):
    ...
    def call(self, inputs, training=None):
        if self.is_mc_dropout:
            return self.call(self.concrete_dropout(inputs))
        else:
...
class ConcreteDropout_old(Wrapper):
    ...
    def __init__(self, layer, weight_regularizer=1e-6, dropout_regularizer=1e-5,
                 init_min=0.1, init_max=0.1, is_mc_dropout=False, **kwargs):
        assert 'kernel_regularizer' not in kwargs
        super(ConcreteDropout_old, self).__init__(layer, **kwargs)
        self.weight_regularizer = weight_regularizer
        self.dropout_regularizer = dropout_regularizer
        self.is_mc_dropout = is_mc_dropout
        self.supports_masking = True
    ...
    def build(self, input_shape=None):
        ...
        super(ConcreteDropout_old, self).build()  # this is very weird.. we must call super before we add new losses
